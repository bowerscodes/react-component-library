...
describe('Hint', () => {
  ...
  it('renders a small hint', () => {
    const hint = 'Small';
    const size = 's';
    const { container } = render(<Hint hintText={hint} size="s"></Hint>);
  ...
  it('renders a medium hint', () => {
    const hint = 'Medium';
    const size = 'm';
    const { container } = render(<Hint hintText={hint} size="m"></Hint>);
    checkSetup(container, hint);
    checkSize(container, hint, size);
  });
  ...
  it('renders a large hint', () => {
    const hint = 'Large';
    const size = 'l';
    const { container } = render(<Hint hintText={hint} size="l"></Hint>);
    checkSetup(container, hint);
    checkSize(container, hint, size);
  });
